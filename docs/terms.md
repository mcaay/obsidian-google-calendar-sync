...
The plugin supports title changes, completion changes, creation of dated Google Tasks, and deletion of linked tasks or individual calendar occurrences. Row deletions have a five-second undo window before they are sent to Google. Calendar scheduling and recurrence are managed in Google. Native Google Tasks reminder times are not available through the public Tasks API.
